...
def duplodata():
    ts_train = np.load('C:/reunion_learned_features/train_0.npy')
    ts_val = np.load('C:/reunion_learned_features/val_0.npy')
    ts_test = np.load('C:/reunion_learned_features/test_0.npy')
    
    labels_train = np.load('C:/ground_truth/train_y0_30.npy')
    labels_val = np.load('C:/ground_truth/validation_y0_20.npy')
    labels_test = np.load('C:/ground_truth/test_y0_30.npy')
